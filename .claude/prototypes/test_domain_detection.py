...
def main():
    ...
    print(
        f"Skills:   F1={metrics1['skills']['f1']} (P={metrics1['skills']['precision']}, R={metrics1['skills']['recall']})"
    )
    print(
        f"Tech:     F1={metrics1['technologies']['f1']} (P={metrics1['technologies']['precision']}, R={metrics1['technologies']['recall']})"
    )
    print(
        f"Req:      F1={metrics1['requirements']['f1']} (P={metrics1['requirements']['precision']}, R={metrics1['requirements']['recall']})"
    )
    ...
    print(
        f"Skills:   F1={metrics2['skills']['f1']} (P={metrics2['skills']['precision']}, R={metrics2['skills']['recall']})"
    )
    print(
        f"Tech:     F1={metrics2['technologies']['f1']} (P={metrics2['technologies']['precision']}, R={metrics2['technologies']['recall']})"
    )
    print(
        f"Req:      F1={metrics2['requirements']['f1']} (P={metrics2['requirements']['precision']}, R={metrics2['requirements']['recall']})"
    )
    ...
    print("-" * 75)
    print(
        f"{'Blue Origin (Aerospace)':<30} {metrics1['skills']['f1']:<15} {metrics1['technologies']['f1']:<15} {metrics1['requirements']['f1']:<15}"
    )
    print(
        f"{'Boeing (Software)':<30} {metrics2['skills']['f1']:<15} {metrics2['technologies']['f1']:<15} {metrics2['requirements']['f1']:<15}"
    )
