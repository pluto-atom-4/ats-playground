...
def categorize_word(word: str) -> str:
    ...
    generic_words = {
        # Verbs
        "planning", "management", "development", "testing", "training",
        "support", "implementation", "analysis", "design", "engineering",
        "operations", "maintenance", "monitoring", "deployment", "debugging",
        "optimization", "coordination", "collaboration", "communication",
        # Nouns (non-tech)
        ...
        # Adjectives
        "strong", "excellent", "good", "high", "low", "large", "small",
        "complex", "simple", "advanced", "basic", "modern", "legacy",
        "distributed", "scalable", "reliable", "secure", "efficient",
