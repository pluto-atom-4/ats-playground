...
NOISE_WORDS_BY_CATEGORY = {
    ...
    "generic_verbs": {
        "do", "make", "have", "be", "get", "go", "come", "know", "take",
        "see", "think", "say", "give", "keep", "try",
    },
    # 6. Numbers & Measurements (18 terms)
    "numbers_measurements": {
        "one", "two", "three", "four", "five", "six", "seven", "eight", "nine",
        "ten", "percent", "years", "months", "weeks", "days", "hours",
        "plus", "minus",
    },
    # 7. Generic Nouns (18 terms)
    "generic_nouns": {
        "thing", "stuff", "way", "work", "life", "area", "part", "type",
        "sort", "kind", "form", "case", "point", "item", "number",
        "level", "range", "value",
    },
    # 8. Filler Words (18 terms)
    "filler_words": {
        "really", "very", "just", "only", "also", "even", "still", "yet",
        "already", "quite", "rather", "somewhat", "somehow", "perhaps",
        "maybe", "actually", "basically",
    },
}
